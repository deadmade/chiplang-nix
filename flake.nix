{
  ...
  inputs = {
    ...
    chip-go = {
      url = "git+https://codeberg.org/ideumi/chip-go?ref=refs/tags/V-1.0.18";
      flake = false;
    };
    boxflinger = {
      url = "git+https://codeberg.org/ideumi/boxflinger?ref=refs/tags/V-1.0.8";
      flake = false;
    };
    depthfinder-src = {
      url = "git+https://codeberg.org/ideumi/depthfinder?ref=refs/tags/V-1.0.4";
      flake = false;
    };
  };
