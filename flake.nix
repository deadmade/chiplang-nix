{
  ...
  inputs = {
    ...
    chip-go = {
      url = "git+https://codeberg.org/ideumi/chip-go?ref=refs/tags/V-1.0.19";
      flake = false;
    };
    boxflinger = {
      url = "git+https://codeberg.org/ideumi/boxflinger?ref=refs/tags/V-1.0.9";
      flake = false;
    };
    depthfinder-src = {
      url = "git+https://codeberg.org/ideumi/depthfinder?ref=refs/tags/V-1.0.5";
      flake = false;
    };
  };
