...
CODEBERG_REPO="boxflinger"
FLAKE_INPUT="boxflinger"
VERSION_KEY="boxflinger"
FLAKE_NIX="flake.nix"
...
if $CI; then
  ...
  echo "commit_message=chore: update boxflinger to ${LATEST_VERSION}" >> "$GITHUB_OUTPUT"
fi

echo "Updated boxflinger to ${LATEST_VERSION}"
