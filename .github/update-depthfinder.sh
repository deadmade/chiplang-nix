...
CODEBERG_REPO="depthfinder"
FLAKE_INPUT="depthfinder-src"
VERSION_KEY="depthfinder"
FLAKE_NIX="flake.nix"
...
if $CI; then
  ...
  echo "commit_message=chore: update depthfinder to ${LATEST_VERSION}" >> "$GITHUB_OUTPUT"
fi

echo "Updated depthfinder to ${LATEST_VERSION}"
