...
CODEBERG_REPO="dfn-mounter"
FLAKE_INPUT="dfn-mounter-src"
VERSION_KEY="dfn-mounter"
FLAKE_NIX="flake.nix"
...
if $CI; then
  ...
  echo "commit_message=chore: update dfn-mounter to ${LATEST_VERSION}" >> "$GITHUB_OUTPUT"
fi

echo "Updated dfn-mounter to ${LATEST_VERSION}"
